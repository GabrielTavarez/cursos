...
# ╔═╡ fa12e9c0-f57e-11eb-1622-93f72e602b0b
begin
	using Flux
...
# ╔═╡ e512dc78-e783-4b88-8b22-5c35cc67675f
begin
	x_train1, y_train1 = MLDatasets.MNIST.traindata()
	x_test1, y_test1 = MLDatasets.MNIST.testdata()
	size(x_train1) #(28,28,60000)
	md"Carrega arquivos no MNIST"
end

# ╔═╡ 1c87fef4-9b5a-4dbc-b165-e20f0c55a947
begin
	x_train =  Flux.unsqueeze(x_train1,3)
	x_test = Flux.unsqueeze(x_test1,3)
	md"Adiciona camada de canal"
end

# ╔═╡ 054dac58-997d-45e1-a363-193b5e8f273d
begin
	y_train = onehotbatch(y_train1,0:9)
	y_teste = onehotbatch(y_test1,0:9)
end

# ╔═╡ d5d2d57a-670e-40a5-baff-aa6c4b202a37
begin
	train_data = DataLoader(Int64.(255*(float32.(x_train))),y_train, batchsize = 128)
end

# ╔═╡ 394bde81-4a85-46e5-8964-8e6ffae1d8a6
x_train(:,:,:,1)
